pipeline <- function(data) {
  ...
  hispanic <- data %>% 
    mutate(hispAny = 100*.[[132]]/.[[4]]) %>% 
    mutate(hispMexican = 100*.[[134]]/.[[4]]) %>% 
    mutate(hispPuerto = 100*.[[136]]/.[[4]]) %>% 
    mutate(hispCuban = 100*.[[138]]/.[[4]]) %>% 
    mutate(hispOther = 100*.[[140]]/.[[4]]) %>% 
    mutate(notHispOneRace = 100*.[[142]]/.[[4]]) %>% 
    mutate(notHispOneWhite = 100*.[[144]]/.[[4]]) %>% 
    mutate(notHispOneBlack = 100*.[[146]]/.[[4]]) %>% 
    mutate(notHispOneNative = 100*.[[148]]/.[[4]]) %>% 
    mutate(notHispOneAsian = 100*.[[150]]/.[[4]]) %>% 
    mutate(notHispOneHawaii = 100*.[[152]]/.[[4]]) %>% 
    mutate(notHispOneOther = 100*.[[154]]/.[[4]]) %>% 
